!(function (e) {
  function t(t) {
    for (
      var n, o, i = t[0], l = t[1], c = t[2], f = 0, p = [];
      f < i.length;
      f++
    )
      (o = i[f]),
        ...
        t.push(
          (o[e] = new Promise(function (t, r) {
            ...
            for (l = 0; l < f.length; l++) {
              var s;
              if ((c = (s = f[l]).getAttribute("data-href")) === n || c === a)
                return t();
            }
  ...
  var l = (this.webpackJsonpdeveloperfolio =
      this.webpackJsonpdeveloperfolio || []),
    c = l.push.bind(l);
  (l.push = t), (l = l.slice());
...
//# sourceMappingURL=runtime-main.9571d86e.js.map
